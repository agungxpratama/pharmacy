  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url()?>">
        ...
        <div class="sidebar-brand-text mx-3">Pharmacy<sup>Kids</sup></div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('index.php/admin/obat'); ?>">
          <i class="fas fa-fw fa-pills"></i>
          <span>Obat</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('index.php/admin/Artikel'); ?>">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!-- <a class="collapse-item" href="buttons.html">Input Obat</a> -->
            <a class="collapse-item" href="<?= base_url('index.php/admin/obat');?>">Daftar Obat</a>
            <a class="collapse-item" href="cards.html">Laporan Obat</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('index.php/admin/artikel');?>">Daftar Artikel</a>
            <a class="collapse-item" href="#">Laporan Artikel</a>
