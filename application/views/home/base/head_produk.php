...
<link rel="stylesheet" type="text/css" href="<?= base_url('assets_home/')?>styles/product.css">
<link rel="stylesheet" type="text/css" href="<?= base_url('assets_home/')?>styles/product_responsive.css">
