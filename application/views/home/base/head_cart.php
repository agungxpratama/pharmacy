...
<link rel="stylesheet" type="text/css" href="<?= base_url('assets_home/')?>styles/cart.css">
<link rel="stylesheet" type="text/css" href="<?= base_url('assets_home/')?>styles/cart_responsive.css">
