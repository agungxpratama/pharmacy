                        ...
                        <div class="billing checkout_section">
                            ...
                            <div class="checkout_form_container">
                                <form action="<?= base_url('index.php/transaksi/simpanCheckout'); ?>" id="form_checkout" class="checkout_form" method="post">
                                    ...
                                    <div> -->
                                        <!-- Company -->
                                        <label for="checkout_company">No Rumah</label>
                                        <input type="text" id="checkout_company" class="checkout_input"  placeholder="No Rumah" name="kantor">
                                    </div>
                                    ...
                                    <div>
                                       ...
                                       <input type="text" id="checkout_city" class="checkout_input" required="required" placeholder="Provinsi" name="provinsi">
                                    </div>
                                    <div>
                                        <!-- Phone no -->
