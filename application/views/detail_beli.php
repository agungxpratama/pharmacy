...
<div class="super_container">
	...
	<!-- <div class="cart_info"> -->
		<div class="container">
			...
			<div class="row cart_items_row" style="margin-left: 230px;">
				<div class="col">
					...
					<div class="cart_item d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
						...
						<div class="cart_item_product d-flex flex-row align-items-center justify-content-start">
							<div class="cart_item_image">
								<div style="right: 180px;"><img src="<?php echo base_url('assets/images/Panadol Kid 0-1_408X300.jpg') ?>"  alt="">
								</div>
							</div>
							<div class="cart_item_name_container" style="left: 0px; top: 30px;">
					...
					<div class="order checkout_section" style="bottom: 50px; left: -131px;">						
						...
						<div class="order_list_container">							
							...
							<ul class="order_list">								
								...
								<div class="offset-lg-2 col-lg-6" style="top: 10px; right: 90px;">									
										<button class="site-btn btn-full" href="checkout.html" style="height:60px; width: 200px; font-size: 25px; border-radius: 15px;"> Beli</button>									
								</div>
					</form>
							</ul>
						</div>																			
